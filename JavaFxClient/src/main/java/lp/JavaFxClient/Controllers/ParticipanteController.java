...
public class ParticipanteController {
    ...
    public void onEventos() {
        ...
        trocarCentro("/participante-eventos-pane.fxml");
    }

    @FXML
    public void onInscricoes() {
        setActive(btnInscricoes);
        trocarCentro("/participante-inscricoes-pane.fxml");
    }

    @FXML
    public void onAvaliacoes() {
        setActive(btnAvaliacoes);
        trocarCentro("/participante-avaliacoes-pane.fxml");
    }

    @FXML
    public void onNotificacoes() {
        setActive(btnNotificacoes);
        trocarCentro("/participante-notificacoes-pane.fxml");
    }
    ...
    private void setActive(Button active) {
        ...
        btnAvaliacoes.setStyle(STYLE_NORMAL);
        btnNotificacoes.setStyle(STYLE_NORMAL);
